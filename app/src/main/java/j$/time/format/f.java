...
public final class f extends j {
    ...
    public final int I(w wVar, CharSequence charSequence, int i) {
        ...
        if (i != length) {
            ...
            j$.time.temporal.s sVarR = this.a.R();
            BigDecimal bigDecimalValueOf = BigDecimal.valueOf(sVarR.a);
            return wVar.g(this.a, bigDecimalMovePointLeft.multiply(BigDecimal.valueOf(sVarR.d).subtract(bigDecimalValueOf).add(BigDecimal.ONE)).setScale(0, RoundingMode.FLOOR).add(bigDecimalValueOf).longValueExact(), i4, i7);
        }
        if (i2 > 0) {
            return ~i;
        }
    ...
    public f(j$.time.temporal.p pVar, int i, int i2, boolean z) {
        ...
        j$.time.temporal.s sVarR = pVar.R();
        if (sVarR.a != sVarR.b || sVarR.c != sVarR.d) {
            j$.nio.file.k.a(j$.time.b.a("Field must have a fixed set of values: ", pVar));
            throw null;
        }
        if (i < 0 || i > 9) {
            j$.nio.file.k.l("Minimum width must be from 0 to 9 inclusive but was ", i);
            throw null;
        }
        if (i2 < 1 || i2 > 9) {
            j$.nio.file.k.l("Maximum width must be from 1 to 9 inclusive but was ", i2);
            throw null;
        }
        if (i2 >= i) {
            return;
    ...
    public final boolean u(y yVar, StringBuilder sb) {
        ...
        j$.time.temporal.s sVarR = pVar.R();
        sVarR.b(jLongValue, pVar);
        BigDecimal bigDecimalValueOf = BigDecimal.valueOf(sVarR.a);
        BigDecimal bigDecimalAdd = BigDecimal.valueOf(sVarR.d).subtract(bigDecimalValueOf).add(BigDecimal.ONE);

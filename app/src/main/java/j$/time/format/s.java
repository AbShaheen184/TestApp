...
public final class s extends j {
    ...
    public final int I(w wVar, CharSequence charSequence, int i) {
        return f(wVar.a.b).I(wVar, charSequence, i);
    }
    ...
    public final j f(Locale locale) {
        ...
        j$.time.temporal.u uVarA = j$.time.temporal.u.a(j$.time.c.a[((((int) (((long) (calendar.getFirstDayOfWeek() - 1)) % 7)) + 7) + j$.time.c.SUNDAY.ordinal()) % 7], calendar.getMinimalDaysInFirstWeek());
        char c = this.g;
        if (c == 'W') {
            tVar = uVarA.d;
        } else {

...
public final class k implements e {
    ...
    public final int I(w wVar, CharSequence charSequence, int i) {
        ...
        if (length2 == 0) {
            ...
            charSequence2 = charSequence;
            if (wVar.h(charSequence2, i, this.a, 0, length2)) {
                return wVar.g(j$.time.temporal.a.OFFSET_SECONDS, 0L, i, i + length2);
            }
        }
        ...
        if (cCharAt == '+' || cCharAt == '-') {
            ...
            if (i9 > 0) {
                ...
                if (i10 <= 23 && (i2 = iArr[2]) <= 59 && (i3 = iArr[3]) <= 59) {
                    return wVar.g(j$.time.temporal.a.OFFSET_SECONDS, ((((long) i2) * 60) + (((long) i10) * 3600) + ((long) i3)) * ((long) i6), i, i9);
                }
                j$.nio.file.k.h("Value out of range: Hour[0-23], Minute[0-59], Second[0-59]");
                return 0;
            }
        }
        return length2 == 0 ? wVar.g(j$.time.temporal.a.OFFSET_SECONDS, 0L, i, i) : ~i;
    }

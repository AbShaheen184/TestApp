...
public final class g implements e {
    ...
    public final boolean u(y yVar, StringBuilder sb) {
        ...
        if (jLongValue >= -62167219200L) {
            ...
            LocalDateTime localDateTimeZ = LocalDateTime.Z(Math.floorMod(j, 315569520000L) - 62167219200L, 0, ZoneOffset.UTC);
            if (jFloorDiv > 0) {
                sb.append('+');
                sb.append(jFloorDiv);
            }
    ...
    public final int I(w wVar, CharSequence charSequence, int i) {
        ...
        wVar2.b = wVar.b;
        wVar2.c = wVar.c;
        int I = dVarC.I(wVar2, charSequence, i);
        if (I < 0) {
            return I;
        }
        ...
        try {
            ...
            return wVar.g(aVar4, iIntValue6, i, wVar.g(j$.time.temporal.a.INSTANT_SECONDS, new LocalDateTime(LocalDate.n0(i3, iIntValue, iIntValue2), j$.time.i.Z(iIntValue3, iIntValue4, iIntValue5, 0)).j0(i2).C(ZoneOffset.UTC) + Math.multiplyExact(jLongValue / 10000, 315569520000L), i, I));

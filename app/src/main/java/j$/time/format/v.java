...
public final class v {
    ...
    public final void n(j$.time.temporal.p pVar, int i2) {
        ...
        if (i2 < 1 || i2 > 19) {
            j$.nio.file.k.l("The width must be from 1 to 19 inclusive but was ", i2);
        } else {
    ...
    public final void o(j$.time.temporal.p pVar, int i2, int i3, f0 f0Var) {
        ...
        if (i2 < 1 || i2 > 19) {
            j$.nio.file.k.l("The minimum width must be from 1 to 19 inclusive but was ", i2);
            return;
        }
        if (i3 < 1 || i3 > 19) {
            j$.nio.file.k.l("The maximum width must be from 1 to 19 inclusive but was ", i3);
            return;
        }
        if (i3 < i2) {
    ...
    public final void f(FormatStyle formatStyle, FormatStyle formatStyle2) {
        if (formatStyle == null && formatStyle2 == null) {
            j$.nio.file.k.a("Either the date or time style must be non-null");
        } else {
        ...
        while (i4 < str.length()) {
            ...
            if ((cCharAt >= 'A' && cCharAt <= 'Z') || (cCharAt >= 'a' && cCharAt <= 'z')) {
                ...
                if (cCharAt == 'p') {
                    ...
                    if (i6 < 1) {
                        j$.nio.file.k.l("The pad width must be at least one but was ", i6);
                        return;
                    }
                    v vVar = this.a;
                    vVar.e = i6;
                ...
                if (pVar != null) {
                    if (cCharAt == 'A') {
                        ...
                        if (cCharAt == 'Q') {
                            ...
                            if (i6 != 1) {
                                j$.nio.file.k.i("Too many pattern letters: ", cCharAt);
                                return;
                            }
                            k(pVar, g0.SHORT);
                        } else if (cCharAt == 'k') {
                    ...
                    if (i6 != 2) {
                        j$.nio.file.k.i("Pattern letter count must be 2: ", cCharAt);
                        return;
                    }
                    ...
                    if (cCharAt == 'Z') {
                        ...
                        if (i6 == 1) {
                            ...
                            if (i6 != 4) {
                                j$.nio.file.k.i("Pattern letter count must be 1 or 4: ", cCharAt);
                                return;
                            }
                            g(g0.FULL);
                        }
                        ...
                        if (cCharAt == 'w') {
                            ...
                            j$.nio.file.k.i("Unknown pattern letter: ", cCharAt);
                            return;
                        } else if (i9 == 2) {
                            l(new s(cCharAt, i9, i9, 2, 0));
                        } else {
                    ...
                    if (i6 != 4) {
                        j$.nio.file.k.i("Wrong number of  pattern letters: ", cCharAt);
                        return;
                    }
    ...
    public final int c(e eVar) {
        ...
        v vVar2 = this.a;
        vVar2.g = -1;
        return ((ArrayList) vVar2.c).size() - 1;
    }
    ...
    public final DateTimeFormatter s(Locale locale, e0 e0Var, j$.time.chrono.l lVar) {
        ...
        return new DateTimeFormatter(new d(this.c, false), locale, c0.a, e0Var, lVar);
    }
}

...
public final class c0 extends d {
    ...
    @Override // j$.time.chrono.b
    public final m W() {
        return Z() >= 1 ? d0.ROC : d0.BEFORE_ROC;
    }
    ...
    public final j$.time.temporal.s l(j$.time.temporal.p pVar) {
        ...
        return j$.time.temporal.s.f(1L, Z() <= 0 ? (-sVar.a) + 1912 : sVar.d - 1911);
    }
        ...
        if (pVar instanceof j$.time.temporal.a) {
            ...
            if (i3 == 4) {
                ...
                if (i != 4) {
                    ...
                    return j0(localDate.y0(i2));
                }
                if (i != 6) {
                    return j0(this.a.y0(iA + 1911));
                }
                if (i == 7) {
                    return j0(this.a.y0(1912 - Z()));
                }
            } else {
                if (i3 == 5) {
                    a0.c.G(aVar).b(j, aVar);
                    long jZ = ((long) Z()) * 12;
    ...
    public final c0 j0(LocalDate localDate) {

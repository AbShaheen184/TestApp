    ...
    public final void readExternal(ObjectInput objectInput) throws IOException {
        ...
        switch (b) {
            case 1:
                ...
                break;
            case 2:
                objOf = ((b) objectInput.readObject()).U((j$.time.i) objectInput.readObject());
                break;
            case 3:
                objOf = ((e) objectInput.readObject()).N((ZoneOffset) objectInput.readObject()).M((ZoneId) objectInput.readObject());
                break;
            case 4:
                ...
                v.c.getClass();
                objOf = new x(LocalDate.n0(i, b2, b3));
                break;
            case 5:
                y yVar = y.d;
            ...
            case 7:
                ...
                a0.c.getClass();
                objOf = new c0(LocalDate.n0(i3 + 1911, b6, b7));
                break;
            case 8:
                ...
                g0.c.getClass();
                objOf = new i0(LocalDate.n0(i4 - 543, b8, b9));
                break;
            case 9:
                int i5 = h.e;

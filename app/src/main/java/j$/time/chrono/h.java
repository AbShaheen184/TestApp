...
public final class h implements j$.time.temporal.o, Serializable {
    ...
    public final j$.time.temporal.l u(j$.time.temporal.l lVar) {
        ...
        if (lVar2 == null || this.a.equals(lVar2)) {
            if (this.c != 0) {
                j$.time.temporal.s sVarG = this.a.G(j$.time.temporal.a.MONTH_OF_YEAR);
                long j = (sVarG.a == sVarG.b && sVarG.c == sVarG.d && sVarG.d()) ? (sVarG.d - sVarG.a) + 1 : -1L;
                int i = this.b;
                if (j > 0) {
                    lVar = lVar.d((((long) i) * j) + ((long) this.c), ChronoUnit.MONTHS);
                } else {
                    if (i != 0) {
        ...
        j$.nio.file.k.f("Chronology mismatch, expected: ", this.a.q(), ", actual: ", lVar2.q());
        return null;
    }

...
public final class t implements p {
    ...
    public final j$.time.chrono.b e(j$.time.chrono.l lVar, int i2, int i3, int i4) {
        j$.time.chrono.b bVarA0 = lVar.a0(i2, 1, 1);
        int iH = h(1, b(bVarA0));
        return bVarA0.d(((Math.min(i3, a(iH, bVarA0.e0() + this.b.b) - 1) - 1) * 7) + (i4 - 1) + (-iH), (TemporalUnit) ChronoUnit.DAYS);
    }
    ...
    public final long Z(TemporalAccessor temporalAccessor) {
        ...
        if (temporalUnit == chronoUnit) {
            ...
            int iG2 = temporalAccessor.g(a.DAY_OF_MONTH);
            iC = a(h(iG2, iB2), iG2);
        }
        return iC;
    }
    ...
    public final int c(TemporalAccessor temporalAccessor) {
        ...
        return iA >= a(iH, ((int) temporalAccessor.l(aVar).d) + this.b.b) ? iG + 1 : iG;
    }
    ...
    public final int d(TemporalAccessor temporalAccessor) {
        ...
        int iA2 = a(iH, iG);
        if (iA2 == 0) {
            return d(j$.time.chrono.l.s(temporalAccessor).P(temporalAccessor).a(iG, (TemporalUnit) ChronoUnit.DAYS));
        }
        return (iA2 <= 50 || iA2 < (iA = a(iH, ((int) temporalAccessor.l(aVar).d) + this.b.b))) ? iA2 : (iA2 - iA) + 1;
    }
    ...
    public final TemporalAccessor O(Map map, d0 d0Var, e0 e0Var) {
        ...
        if (temporalUnit == chronoUnit2) {
            ...
            if (map.containsKey(aVar3)) {
                ...
                long j = intExact;
                if (e0Var == e0.LENIENT) {
                    j$.time.chrono.b bVarD4 = lVarS.a0(iA2, 1, 1).d(Math.subtractExact(jLongValue2, 1L), (TemporalUnit) chronoUnit2);
                    int iB = b(bVarD4);
                    int iG = bVarD4.g(a.DAY_OF_MONTH);
                    bVarD3 = bVarD4.d(Math.addExact(Math.multiplyExact(Math.subtractExact(j, a(h(iG, iB), iG)), 7), iFloorMod - b(bVarD4)), (TemporalUnit) ChronoUnit.DAYS);
                } else {
                    j$.time.chrono.b bVarA0 = lVarS.a0(iA2, aVar3.b.a(jLongValue2, aVar3), 1);
                    long jA = sVar.a(j, this);
                    int iB2 = b(bVarA0);
                    int iG2 = bVarA0.g(a.DAY_OF_MONTH);
                    j$.time.chrono.b bVarD5 = bVarA0.d((((int) (jA - ((long) a(h(iG2, iB2), iG2)))) * 7) + (iFloorMod - b(bVarA0)), (TemporalUnit) ChronoUnit.DAYS);
        ...
        long j2 = intExact;
        j$.time.chrono.b bVarA1 = lVarS.a0(iA2, 1, 1);
        if (e0Var == e0.LENIENT) {
            int iB3 = b(bVarA1);
            int iG3 = bVarA1.g(a.DAY_OF_YEAR);
            bVarD2 = bVarA1.d(Math.addExact(Math.multiplyExact(Math.subtractExact(j2, a(h(iG3, iB3), iG3)), 7), iFloorMod - b(bVarA1)), (TemporalUnit) ChronoUnit.DAYS);
        } else {
            long jA2 = sVar.a(j2, this);
            int iB4 = b(bVarA1);
            int iG4 = bVarA1.g(a.DAY_OF_YEAR);
            j$.time.chrono.b bVarD6 = bVarA1.d((((int) (jA2 - ((long) a(h(iG4, iB4), iG4)))) * 7) + (iFloorMod - b(bVarA1)), (TemporalUnit) ChronoUnit.DAYS);
    ...
    public final s g(TemporalAccessor temporalAccessor) {
        ...
        if (iA != 0) {
            ...
            if (iA >= iA2) {
                return g(j$.time.chrono.l.s(temporalAccessor).P(temporalAccessor).d((i2 - iG) + 8, (TemporalUnit) ChronoUnit.DAYS));
            }
            return s.f(1L, iA2 - 1);
        }
        return g(j$.time.chrono.l.s(temporalAccessor).P(temporalAccessor).a(iG + 7, (TemporalUnit) ChronoUnit.DAYS));
    }

    ...
    public final void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        switch (b) {
            ...
            case 5:
                ...
                localDateTime.b.t0(objectOutput);
                return;
            case 6:
                ...
                localDateTime2.b.t0(objectOutput);
                zonedDateTime.b.p0(objectOutput);
                zonedDateTime.c.g0(objectOutput);
                return;
            case 7:
                objectOutput.writeUTF(((v) obj).b);
                return;
            case 8:
                ((ZoneOffset) obj).p0(objectOutput);
                return;
            case 9:
                o oVar = (o) obj;
                oVar.a.t0(objectOutput);
                oVar.b.p0(objectOutput);
                return;
            case 10:
                ...
                localDateTime3.b.t0(objectOutput);
                offsetDateTime.b.p0(objectOutput);
                return;
            case 11:
    ...
    public static Object a(byte b, ObjectInput objectInput) throws IOException {
        switch (b) {
            case 1:
                ...
                return Duration.I(Math.addExact(j, Math.floorDiv(j2, 1000000000L)), (int) Math.floorMod(j2, 1000000000L));
            case 2:
                Instant instant = Instant.c;
                return Instant.O(objectInput.readLong(), objectInput.readInt());
            case 3:
                LocalDate localDate = LocalDate.d;
                return LocalDate.n0(objectInput.readInt(), objectInput.readByte(), objectInput.readByte());
            case 4:
                return i.o0(objectInput);
            case 5:
                LocalDateTime localDateTime = LocalDateTime.c;
                LocalDate localDate2 = LocalDate.d;
                return LocalDateTime.R(LocalDate.n0(objectInput.readInt(), objectInput.readByte(), objectInput.readByte()), i.o0(objectInput));
            case 6:
                LocalDateTime localDateTime2 = LocalDateTime.c;
                LocalDate localDate3 = LocalDate.d;
                LocalDateTime localDateTimeR = LocalDateTime.R(LocalDate.n0(objectInput.readInt(), objectInput.readByte(), objectInput.readByte()), i.o0(objectInput));
                ZoneOffset zoneOffsetO0 = ZoneOffset.o0(objectInput);
                ZoneId zoneId = (ZoneId) a(objectInput.readByte(), objectInput);
                Objects.requireNonNull(zoneId, "zone");
                if (!(zoneId instanceof ZoneOffset) || zoneOffsetO0.equals(zoneId)) {
                    return new ZonedDateTime(localDateTimeR, zoneId, zoneOffsetO0);
                }
            ...
            case 8:
                return ZoneOffset.o0(objectInput);
            case 9:
                int i2 = o.c;
                return new o(i.o0(objectInput), ZoneOffset.o0(objectInput));
            case 10:
                int i3 = OffsetDateTime.c;
                LocalDate localDate4 = LocalDate.d;
                return new OffsetDateTime(LocalDateTime.R(LocalDate.n0(objectInput.readInt(), objectInput.readByte(), objectInput.readByte()), i.o0(objectInput)), ZoneOffset.o0(objectInput));
            case 11:
                int i4 = s.b;
            ...
            case 12:
                ...
                j$.time.temporal.a.YEAR.j0(i6);
                j$.time.temporal.a.MONTH_OF_YEAR.j0(b2);
                return new u(i6, b2);
            case 13:
                int i7 = m.c;
                ...
                j$.time.temporal.a.DAY_OF_MONTH.j0(b4);
                if (b4 <= kVarR.O()) {
                    return new m(kVarR.getValue(), b4);
                }
                throw new DateTimeException("Illegal value for DayOfMonth field, value " + ((int) b4) + " is not valid for month " + kVarR.name());
            case 14:
                p pVar = p.d;

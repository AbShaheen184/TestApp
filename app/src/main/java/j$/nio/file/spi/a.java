...
public final /* synthetic */ class a extends c {
    ...
    public final /* synthetic */ n h(Path path, Class cls, LinkOption[] linkOptionArr) {
        ...
        if (fileOwnerAttributeView instanceof j$.nio.file.attribute.p) {
            return ((j$.nio.file.attribute.p) fileOwnerAttributeView).a;
        }
    ...
    public final /* synthetic */ h t(Path path, Map map) {
        return f.k(this.b.newFileSystem(p.u(path), (Map<String, ?>) map));
    }
    ...
    public final DirectoryStream r(Path path, j$.desugar.sun.nio.fs.h hVar) {
        return new r(this.b.newDirectoryStream(p.u(path), new j$.desugar.sun.nio.fs.h(hVar)));
    }
}

...
public final class OptRuntime extends ScriptRuntime {
    ...
    public static Object add(Object obj, double d, Context context) {
        ...
        return obj instanceof Integer ? Double.valueOf(((double) ((Integer) obj).intValue()) + d) : ScriptRuntime.add(obj, Double.valueOf(d), context);
    }
    ...
    public static void main(Script script, String[] strArr) {
        ContextFactory.getGlobal().call(new androidx.media3.exoplayer.analytics.c(13, strArr, script));
    }

...
public class PolicySecurityController extends SecurityController {
    ...
    private static byte[] loadBytecode() {
        ...
        classFileWriter.g(0);
        classFileWriter.m(name, Token.TAGGED_TEMPLATE_LITERAL, "<init>", "()V");
        classFileWriter.c(Token.METHOD);
        classFileWriter.O(1);
        classFileWriter.N("call", "(Lorg/mozilla/javascript/Callable;Lorg/mozilla/javascript/Context;Lorg/mozilla/javascript/Scriptable;Lorg/mozilla/javascript/Scriptable;[Ljava/lang/Object;)Ljava/lang/Object;", (short) 17);
        for (int i = 1; i < 6; i++) {
            classFileWriter.g(i);
        }
        classFileWriter.m("org/mozilla/javascript/Callable", 185, "call", "(Lorg/mozilla/javascript/Context;Lorg/mozilla/javascript/Scriptable;Lorg/mozilla/javascript/Scriptable;[Ljava/lang/Object;)Ljava/lang/Object;");

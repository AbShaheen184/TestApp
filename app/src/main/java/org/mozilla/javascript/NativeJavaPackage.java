...
public class NativeJavaPackage extends ScriptableObject {
    ...
    public NativeJavaPackage forcePackage(String str, Scriptable scriptable) {
        ...
        NativeJavaPackage nativeJavaPackage = new NativeJavaPackage(true, this.packageName.length() == 0 ? str : androidx.compose.runtime.external.kotlinx.collections.immutable.internal.c.i(this.packageName, ".", str), this.classLoader);
    ...
    public String toString() {
        return androidx.privacysandbox.ads.adservices.java.internal.a.q("[JavaPackage ", this.packageName, "]");
    }

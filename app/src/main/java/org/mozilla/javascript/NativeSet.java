...
public class NativeSet extends IdScriptableObject {
    ...
    public Object execIdCall(IdFunctionObject idFunctionObject, Context context, Scriptable scriptable, Scriptable scriptable2, Object[] objArr) {
        ...
        switch (idFunctionObject.methodId()) {
            ...
            default:
                net.luminis.tls.engine.impl.c.o(androidx.compose.runtime.external.kotlinx.collections.immutable.internal.c.h("Set.prototype has no method: ", idFunctionObject.getFunctionName()));
                return null;
        }
    }

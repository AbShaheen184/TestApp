...
public class ScriptRuntime {
    ...
    public static Number bitwiseNOT(Number number) {
        ...
        return number instanceof Integer ? Integer.valueOf(~((Integer) number).intValue()) : Double.valueOf(~toInt32(number.doubleValue()));
    }
    ...
    public static Ref callRef(Callable callable, Scriptable scriptable, Object[] objArr, Context context) {
        ...
        net.luminis.tls.engine.impl.c.r(refCallable.getClass().getName().concat(".refCall() returned null"));
        return null;
    }
    ...
    public static Optional<Double> canonicalNumericIndexString(String str) {
        ...
        return toString(number).equals(str) ? Optional.of(Double.valueOf(number)) : Optional.empty();
    }
    ...
    public static String defaultObjectToString(Scriptable scriptable) {
        ...
        return property instanceof CharSequence ? androidx.privacysandbox.ads.adservices.java.internal.a.q("[object ", String.valueOf(property), "]") : androidx.privacysandbox.ads.adservices.java.internal.a.q("[object ", scriptable.getClassName(), "]");
    }
    ...
    private static Object doScriptableIncrDecr(Scriptable scriptable, String str, Scriptable scriptable2, Object obj, int i) {
        ...
        if (numeric instanceof BigInteger) {
            objValueOf = (i & 1) == 0 ? ((BigInteger) numeric).add(BigInteger.ONE) : ((BigInteger) numeric).subtract(BigInteger.ONE);
        } else if (numeric instanceof Integer) {
            objValueOf = (i & 1) == 0 ? Integer.valueOf(((Integer) numeric).intValue() + 1) : Integer.valueOf(((Integer) numeric).intValue() - 1);
        } else {
            objValueOf = (i & 1) == 0 ? Double.valueOf(numeric.doubleValue() + 1.0d) : Double.valueOf(numeric.doubleValue() - 1.0d);
        }
        scriptable.put(str, scriptable2, objValueOf);
        return z ? numeric : objValueOf;
    }
    ...
    public static Object elemIncrDecr(Object obj, Object obj2, Context context, Scriptable scriptable, int i) {
        ...
        setObjectElem(obj, obj2, objValueOf, context, scriptable);
        return z ? numeric : objValueOf;
    }
    ...
    public static boolean eqBigInt(BigInteger bigInteger, Object obj) {
        Object objEquivalentValues;
        while (obj != null && !Undefined.isUndefined(obj)) {
            if (!(obj instanceof BigInteger)) {
                if (!(obj instanceof Number)) {
                    if (!(obj instanceof CharSequence)) {
                        if (!(obj instanceof Boolean)) {
    ...
    public static Object evalSpecial(Context context, Scriptable scriptable, Object obj, Object[] objArr, String str, int i) {
        ...
        Script scriptCompileString = context.compileString(obj2.toString(), evaluatorCreateInterpreter, errorReporterForEval, strMakeUrlForGeneratedScript, 1, null, new q(scriptable, 1));
        ...
        for (int i = 0; i != length; i++) {
            ...
            if (i2 != 0) {
                ...
                if (num2.intValue() >= 0) {
                    ...
                    stringIdOrIndex = toStringIdOrIndex(string);
                    str = stringIdOrIndex.stringId;
                    if (str == null) {
                        scriptable.put(stringIdOrIndex.index, scriptable, obj);
                    } else {
                        zIsSpecialProperty = isSpecialProperty(str);
                        str2 = stringIdOrIndex.stringId;
    ...
    public static Scriptable getApplyOrCallThis(Context context, Scriptable scriptable, Object obj, int i) {
        ...
        if (i != 0) {
            objectOrNull = (obj != Undefined.instance || context.hasFeature(15)) ? toObjectOrNull(context, obj, scriptable) : Undefined.SCRIPTABLE_UNDEFINED;
        } else {
            objectOrNull = null;
        }
    ...
    */
    ...
    /* JADX WARN: Code duplicated, block: B:50:0x0087 A[LOOP:0: B:3:0x0003->B:50:0x0087, LOOP_END] */
                ...
                if (th instanceof EcmaError) {
                    ...
                    if (th instanceof WrappedException) {
                        ...
                        if (isVisible(context, wrappedException2)) {
                            ...
                            strI = androidx.compose.runtime.external.kotlinx.collections.immutable.internal.c.i(wrappedException2.getClass().getName(), ": ", wrappedException2.getMessage());
                        } else {
                            nativeErrors = TopLevel.NativeErrors.InternalError;
                            strI = wrappedException2.getMessage();
                        }
                    ...
                    if (iLineNumber > 0) {
                        objArr = new Object[]{strI, strSourceName, Integer.valueOf(iLineNumber)};
                    } else {
                        objArr = new Object[]{strI, strSourceName};
                    }
    ...
    public static String numberToString(double d, int i) {
        ...
        return d == 0.0d ? "0" : DToA.JS_dtobasestr(i, d);
    }
    ...
    public static Object refIncrDecr(Ref ref, Context context, Scriptable scriptable, int i) {
        ...
        ref.set(context, scriptable, objValueOf);
        return z ? numeric : objValueOf;
    }
    ...
    public static Object toPrimitive(Object obj, Class<?> cls) {
        ...
        if (cls == null) {
            ...
            str = StringClass == cls ? "string" : "number";
        }
        Object objCall = function.call(currentContext, parentScope, scriptable, new Object[]{str});
        if (isObject(objCall)) {
    ...
    public static Scriptable wrapException(Throwable th, Scriptable scriptable, Context context) {
        ...
        if (!(th instanceof EcmaError)) {
            if (th instanceof WrappedException) {
                WrappedException wrappedException = (WrappedException) th;
                Throwable wrappedException2 = wrappedException.getWrappedException();
                string = androidx.compose.runtime.external.kotlinx.collections.immutable.internal.c.i(wrappedException2.getClass().getName(), ": ", wrappedException2.getMessage());
                th2 = wrappedException2;
                name = "JavaException";
    ...
    public static class DefaultMessageProvider implements MessageProvider {
        ...
        public String getMessage(String str, Object[] objArr) {
            ...
            try {
                ...
                c.b(androidx.compose.runtime.external.kotlinx.collections.immutable.internal.c.h("no message resource found for message property ", str));
                return null;
            }
        }
    ...
    public static BigInteger toBigInt(String str) {
        ...
        for (int i3 = 0; i3 != length; i3++) {
            ...
            if (!isStrWhiteSpaceChar(cCharAt)) {
                ...
                if (cCharAt == '0' && (i = i3 + 2) <= length) {
                    char cCharAt2 = str.charAt(i3 + 1);
                    if (cCharAt2 == 'x' || cCharAt2 == 'X') {
                        i2 = 16;
                    } else if (cCharAt2 == 'o' || cCharAt2 == 'O') {
                        i2 = 8;
                    } else {
                        i2 = (cCharAt2 == 'b' || cCharAt2 == 'B') ? 2 : -1;
                    }
                    if (i2 != -1) {
                        try {
                            return new BigInteger(str.substring(i, length + 1), i2);
                        } catch (NumberFormatException unused) {

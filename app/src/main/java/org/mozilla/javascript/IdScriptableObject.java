...
public abstract class IdScriptableObject extends ScriptableObject implements IdFunctionCall {
    ...
    public void setInstanceIdAttributes(int i, int i2) {
        throw ScriptRuntime.constructError("InternalError", androidx.compose.runtime.external.kotlinx.collections.immutable.internal.c.j("Changing attributes not supported for ", getClassName(), " ", getInstanceIdName(i), " property"));
    }
    ...
    public static final class PrototypeValues implements Serializable {
        ...
        public final IdFunctionObject createPrecachedConstructor() {
            ...
            if (iFindPrototypeId == 0) {
                net.luminis.tls.engine.impl.c.r("No id for constructor property");
                return null;
            }
            ...
            throw new IllegalStateException(idScriptableObject.getClass().getName() + ".initPrototypeId() did not initialize id=" + this.constructorId);
        }
        ...
        public final void initValue(int i, String str, Object obj, int i2) {
            ...
            if (i != this.constructorId) {
                ...
                net.luminis.tls.engine.impl.c.o("constructor should be initialized with IdFunctionObject");
            } else {
        ...
        public final void initValue(int i, Symbol symbol, Object obj, int i2) {
            ...
            if (symbol != null) {
                if (obj != Scriptable.NOT_FOUND) {
                    ...
                    net.luminis.tls.engine.impl.c.p(symbol);
                    return;
                }
                net.luminis.tls.engine.impl.c.a();
                return;

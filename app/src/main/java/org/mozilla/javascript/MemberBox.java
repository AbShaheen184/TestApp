...
final class MemberBox implements Serializable {
    ...
    private static Member readMember(ObjectInputStream objectInputStream) throws IOException {
        ...
        try {
            ...
            net.luminis.tls.engine.impl.c.t("Cannot find member: ".concat(String.valueOf(e)));
            return null;
        }
    }
    ...
    private static void writeMember(ObjectOutputStream objectOutputStream, Member member) throws IOException {
        ...
        if (!z && !(member instanceof Constructor)) {
            net.luminis.tls.engine.impl.c.o("not Method or Constructor");
            return;
        }
        ...
        for (Class<?> cls : clsArr) {
            ...
            if (zIsPrimitive) {
                ...
                while (true) {
                    ...
                    if (i >= clsArr2.length) {
                        net.luminis.tls.engine.impl.c.o(androidx.privacysandbox.ads.adservices.java.internal.a.q("Primitive ", String.valueOf(cls), " not found"));
                        return;
                    } else {

...
public class Context implements Closeable {
    ...
    public Context(ContextFactory contextFactory) {
        ...
        if (contextFactory == null) {
            net.luminis.tls.engine.impl.c.o("factory == null");
            throw null;
        }
    ...
    public static void checkLanguageVersion(int i) {
        ...
        net.luminis.tls.engine.impl.c.o(androidx.privacysandbox.ads.adservices.java.internal.a.l(i, "Bad language version: "));
    }
    ...
    public static void checkOptimizationLevel(int i) {
        ...
        net.luminis.tls.engine.impl.c.o(androidx.privacysandbox.ads.adservices.java.internal.a.l(i, "Optimization level outside [-1..9]: "));
    }
        ...
        if (context2 == null) {
            if (context == null) {
                ...
                if (context.enterCount != 0) {
                    net.luminis.tls.engine.impl.c.r("factory.makeContext() returned Context instance already associated with some thread");
                    return null;
                }
                ...
                net.luminis.tls.engine.impl.c.r("can not use Context instance already associated with some thread");
                return null;
            }
    ...
    public static void exit() {
        ...
        if (context == null) {
            net.luminis.tls.engine.impl.c.r("Calling Context.exit without previous Context.enter");
            return;
        }
    ...
    public static Context getContext() {
        ...
        c.b("No Context associated with current Thread");
        return null;
    }
    ...
    private ScriptNode parse(String str, String str2, int i, CompilerEnvirons compilerEnvirons, ErrorReporter errorReporter, boolean z) {
        ...
        if (z && (astRoot.getFirstChild() == null || astRoot.getFirstChild().getType() != 122)) {
            net.luminis.tls.engine.impl.c.o(androidx.compose.runtime.external.kotlinx.collections.immutable.internal.c.h("compileFunction only accepts source with single JS function: ", str));
            return null;
        }
    ...
    public Object callFunctionWithContinuations(Callable callable, Scriptable scriptable, Object[] objArr) {
        if (!(callable instanceof InterpretedFunction)) {
            net.luminis.tls.engine.impl.c.o("Function argument was not created by interpreted mode ");
            return null;
        }
        if (ScriptRuntime.hasTopCall(this)) {
            net.luminis.tls.engine.impl.c.r("Cannot have any pending top calls when executing a script with continuations");
            return null;
        }
    ...
    public Object compileImpl(Scriptable scriptable, String str, String str2, int i, Object obj, boolean z, Evaluator evaluator, ErrorReporter errorReporter, Consumer<CompilerEnvirons> consumer) {
        ...
        if (obj != null && getSecurityController() == null) {
            net.luminis.tls.engine.impl.c.o("securityDomain should be null if setSecurityController() was never called");
            return null;
        }
        ...
        if (evaluator == null) {
            ...
            } catch (org.mozilla.classfile.d unused) {
                ScriptNode scriptNode2 = parse(str, str3, i, compilerEnvirons, errorReporter2, z);
                evaluator = createInterpreter();
                objCompile = evaluator.compile(compilerEnvirons, scriptNode2, str, z);
            }
        }
        objCompile = evaluator.compile(compilerEnvirons, scriptNode, str, z);
        ...
        return z ? evaluator.createFunctionObject(this, scriptable, objCompile, obj) : evaluator.createScriptObject(objCompile, obj);
    }
    ...
    public final String decompileFunction(Function function, int i) {
        return function instanceof BaseFunction ? ((BaseFunction) function).decompile(i, EnumSet.noneOf(DecompilerFlag.class)) : androidx.privacysandbox.ads.adservices.java.internal.a.q("function ", function.getClassName(), "() {\n\t[native code]\n}\n");
    }
    ...
    public Object executeScriptWithContinuations(Script script, Scriptable scriptable) {
        ...
        net.luminis.tls.engine.impl.c.o("Script argument was not a script or was not created by interpreted mode ");
        return null;
    }
    ...
    public final void setApplicationClassLoader(ClassLoader classLoader) {
        ...
        if (classLoader == null) {
            ...
            net.luminis.tls.engine.impl.c.o("Loader can not resolve Rhino classes");
        }
    }
    ...
    public void setJavaToJSONConverter(UnaryOperator<Object> unaryOperator) {
        if (unaryOperator != null) {
            ...
            net.luminis.tls.engine.impl.c.o("javaToJSONConverter == null");
        }
    }
    ...
    public final void setMaximumInterpreterStackDepth(int i) {
        ...
        if (!this.interpretedMode) {
            net.luminis.tls.engine.impl.c.r("Cannot set maximumInterpreterStackDepth outside interpreted mode");
        } else if (i >= 1) {
            this.maximumInterpreterStackDepth = i;
        } else {
            net.luminis.tls.engine.impl.c.o("Cannot set maximumInterpreterStackDepth to less than 1");
        }
    }
    ...
    public static Object call(ContextFactory contextFactory, final Callable callable, final Scriptable scriptable, final Scriptable scriptable2, final Object[] objArr) {
        ...
        return call(contextFactory, new ContextAction() { // from class: org.mozilla.javascript.d
            @Override // org.mozilla.javascript.ContextAction
            public final Object run(Context context) {
                return Context.lambda$call$0(callable, scriptable, scriptable2, objArr, context);
            }
        });
    }

...
public final class IRFactory {
    ...
    private Node arrayCompTransformHelper(ArrayComprehension arrayComprehension, String str) throws Throwable {
        ...
        Node node = new Node(Token.EXPR_VOID, nodeCreateCallOrNew);
        node.setLineColumnNumber(lineno, column);
        Node node2 = null;
        if (arrayComprehension.getFilter() != null) {
            node = createIf(transform(arrayComprehension.getFilter()), node, null, lineno, column);
        }
        ...
        while (i3 >= 0) {
            try {
                ...
                Scope scopeCreateLoopNode = createLoopNode(node2, arrayComprehensionLoop2.getLineno(), arrayComprehensionLoop2.getColumn());
                this.parser.pushScope(scopeCreateLoopNode);
                int i5 = i4 + 1;
                Node node3 = node2;
                try {
                    nodeCreateForIn = createForIn(Token.LET, scopeCreateLoopNode, nodeArr[i3], nodeArr2[i3], nodeCreateForIn, arrayComprehensionLoop2, arrayComprehensionLoop2.isForEach(), arrayComprehensionLoop2.isForOf());
                    i3--;
                    i4 = i5;
                    node2 = node3;
                } catch (Throwable th2) {
    ...
    private Node createAssignment(int i, Node node, Node node2) {
        ...
        if (nodeMakeReference == null) {
            ...
            Parser parser = this.parser;
            if (i == 99) {
                return parser.createDestructuringAssignment(-1, node, node2, new j(this));
            }
    ...
    */
    ...
    private static Node createCondExpr(Node node, Node node2, Node node3) {
        ...
        return iIsAlwaysDefinedBoolean == -1 ? node3 : new Node(Token.HOOK, node, node2, node3);
    }
    ...
    /* JADX WARN: Code duplicated, block: B:47:0x00bc A[Catch: all -> 0x0037, TRY_ENTER, TryCatch #0 {all -> 0x0037, blocks: (B:3:0x000b, B:11:0x0026, B:13:0x002c, B:36:0x007a, B:44:0x0092, B:47:0x00bc, B:53:0x00d0, B:55:0x00dc, B:60:0x0107, B:59:0x0104, B:54:0x00d8, B:20:0x003d, B:22:0x0041, B:24:0x004b, B:30:0x005c, B:31:0x0067, B:32:0x006d, B:34:0x0071), top: B:64:0x000b }] */
    /* JADX WARN: Code duplicated, block: B:49:0x00c9 A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:54:0x00d8 A[Catch: all -> 0x0037, TryCatch #0 {all -> 0x0037, blocks: (B:3:0x000b, B:11:0x0026, B:13:0x002c, B:36:0x007a, B:44:0x0092, B:47:0x00bc, B:53:0x00d0, B:55:0x00dc, B:60:0x0107, B:59:0x0104, B:54:0x00d8, B:20:0x003d, B:22:0x0041, B:24:0x004b, B:30:0x005c, B:31:0x0067, B:32:0x006d, B:34:0x0071), top: B:64:0x000b }] */
    /* JADX WARN: Code duplicated, block: B:57:0x0100  */
    /* JADX WARN: Code duplicated, block: B:59:0x0104 A[Catch: all -> 0x0037, TryCatch #0 {all -> 0x0037, blocks: (B:3:0x000b, B:11:0x0026, B:13:0x002c, B:36:0x007a, B:44:0x0092, B:47:0x00bc, B:53:0x00d0, B:55:0x00dc, B:60:0x0107, B:59:0x0104, B:54:0x00d8, B:20:0x003d, B:22:0x0041, B:24:0x004b, B:30:0x005c, B:31:0x0067, B:32:0x006d, B:34:0x0071), top: B:64:0x000b }] */
    private Node createForIn(int i, Node node, Node node2, Node node3, Node node4, AstNode astNode, boolean z, boolean z2) {
        Node nodeNewString;
        int i2;
        Node node5;
        Parser parser;
        ...
        try {
            ...
            if (type == 135 || type == 167) {
                ...
                if (type == 71 || type == 72) {
                    ...
                    type = type;
                    node6 = new Node(Token.LOCAL_BLOCK);
                    if (z) {
                        i2 = 64;
                    } else if (z2) {
                        i2 = 66;
                    ...
                    Node node7 = new Node(i2, node3);
                    node7.putProp(3, node6);
                    Node node8 = new Node(67);
                    node8.putProp(3, node6);
                    node5 = new Node(68);
                    node5.putProp(3, node6);
                    Node node9 = new Node(Token.BLOCK);
                    parser = this.parser;
                    if (type != -1) {
                        nodeSimpleAssignment = parser.createDestructuringAssignment(i, nodeNewString, node5, new j(this));
                        if (!z && !z2 && (type == 72 || destructuringLength != 2)) {
                            this.parser.reportError("msg.bad.for.in.destruct");
                        }
                    } else {
                        nodeSimpleAssignment = parser.simpleAssignment(nodeNewString, node5);
                    }
                    node9.addChildToBack(new Node(Token.EXPR_VOID, nodeSimpleAssignment));
                    node9.addChildToBack(node4);
                    nodeCreateLoop = createLoop((Jump) node, 1, node9, node8, null, null);
                    nodeCreateLoop.addChildToFront(node7);
                    if (type != 135 || type == 167) {
                        nodeCreateLoop.addChildToFront(node2);
                    }
                    node6.addChildToBack(nodeCreateLoop);
                } else if (type == 44) {
                    nodeNewString = Node.newString(44, lastChild.getString());
                    type = -1;
                    node6 = new Node(Token.LOCAL_BLOCK);
                    if (z) {
                        i2 = 64;
                    ...
                    Node node10 = new Node(i2, node3);
                    node10.putProp(3, node6);
                    Node node11 = new Node(67);
                    node11.putProp(3, node6);
                    node5 = new Node(68);
                    node5.putProp(3, node6);
                    Node node12 = new Node(Token.BLOCK);
                    parser = this.parser;
                    if (type != -1) {
                        nodeSimpleAssignment = parser.createDestructuringAssignment(i, nodeNewString, node5, new j(this));
                        if (!z) {
                    ...
                    node12.addChildToBack(new Node(Token.EXPR_VOID, nodeSimpleAssignment));
                    node12.addChildToBack(node4);
                    nodeCreateLoop = createLoop((Jump) node, 1, node12, node11, null, null);
                    nodeCreateLoop.addChildToFront(node10);
                    if (type != 135) {
                        nodeCreateLoop.addChildToFront(node2);
                    } else {
                        nodeCreateLoop.addChildToFront(node2);
                ...
                Node node13 = new Node(i2, node3);
                node13.putProp(3, node6);
                Node node14 = new Node(67);
                node14.putProp(3, node6);
                node5 = new Node(68);
                node5.putProp(3, node6);
                Node node15 = new Node(Token.BLOCK);
                parser = this.parser;
                if (type != -1) {
                    nodeSimpleAssignment = parser.createDestructuringAssignment(i, nodeNewString, node5, new j(this));
                    if (!z) {
                ...
                node15.addChildToBack(new Node(Token.EXPR_VOID, nodeSimpleAssignment));
                node15.addChildToBack(node4);
                nodeCreateLoop = createLoop((Jump) node, 1, node15, node14, null, null);
                nodeCreateLoop.addChildToFront(node13);
                if (type != 135) {
                    nodeCreateLoop.addChildToFront(node2);
                } else {
                    nodeCreateLoop.addChildToFront(node2);
                ...
                if (nodeNewString == null) {
                    ...
                    Node node16 = new Node(i2, node3);
                    node16.putProp(3, node6);
                    Node node17 = new Node(67);
                    node17.putProp(3, node6);
                    node5 = new Node(68);
                    node5.putProp(3, node6);
                    Node node18 = new Node(Token.BLOCK);
                    parser = this.parser;
                    if (type != -1) {
                        nodeSimpleAssignment = parser.createDestructuringAssignment(i, nodeNewString, node5, new j(this));
                        if (!z) {
                    ...
                    node18.addChildToBack(new Node(Token.EXPR_VOID, nodeSimpleAssignment));
                    node18.addChildToBack(node4);
                    nodeCreateLoop = createLoop((Jump) node, 1, node18, node17, null, null);
                    nodeCreateLoop.addChildToFront(node16);
                    if (type != 135) {
                        nodeCreateLoop.addChildToFront(node2);
                    } else {
                        nodeCreateLoop.addChildToFront(node2);
    ...
    private Node createMemberRefGet(Node node, String str, Node node2, int i) {
        ...
        Node node4;
        if (str != null) {
            node3 = str.equals("*") ? new Node(47) : this.parser.createName(str);
        } else {
            node3 = null;
        }
        if (node == null) {
            node4 = str == null ? new Node(87, node2) : new Node(88, node3, node2);
        } else {
            node4 = str == null ? new Node(85, node, node2) : new Node(86, node, node3, node2);
        }
        if (i != 0) {
                                    ...
                                    default:
                                        switch (type) {
                                            ...
                                            default:
                                                ...
                                                net.luminis.tls.engine.impl.c.o("Can't transform: ".concat(String.valueOf(astNode)));
                                                return null;
                                        }
                                        break;
                                }
    ...
    private Node transformFunction(FunctionNode functionNode) throws Throwable {
        ...
        try {
                ...
                while (size > 0) {
                    if (defaultParams.get(size) instanceof AstNode) {
                        ...
                        if (defaultParams.get(i) instanceof String) {
                            ...
                            try {
                                perFunctionVariables = perFunctionVariablesCreatePerFunctionVariables;
                                try {
                                    nodeTransform.addChildToFront(createIf(createBinary(51, this.parser.createName(str), this.parser.createName("undefined")), new Node(Token.EXPR_VOID, createAssignment(99, this.parser.createName(str), transform(astNode)), nodeTransform.getLineno(), nodeTransform.getColumn()), null, nodeTransform.getLineno(), nodeTransform.getColumn()));
                                } catch (Throwable th) {
                                    th = th;
                                    this.parser.nestingOfFunction--;
                    ...
                    size -= 2;
                    z = z;
                    perFunctionVariablesCreatePerFunctionVariables = perFunctionVariables;
                }
            }
            perFunctionVariables = perFunctionVariablesCreatePerFunctionVariables;
            boolean z2 = z;
            ...
            if (node != null) {
                nodeTransform.addChildToFront(new Node(Token.EXPR_VOID, node, lineno, column));
            }
            int functionType = functionNode.getFunctionType();
            Node nodeInitFunction = initFunction(functionNode, iAddFunction, nodeTransform, functionType);
    ...
    private Node transformObjectLiteral(ObjectLiteral objectLiteral) {
        ...
        if (elements.isEmpty()) {
            ...
            for (ObjectProperty objectProperty : elements) {
                ...
                if (propKey == null) {
                    i = i2 + 1;
                    objArr[i2] = transform(objectProperty.getLeft());
                } else {
                    i = i2 + 1;
                    objArr[i2] = propKey;
                }
    ...
    private Node transformTry(TryStatement tryStatement) {
        ...
        while (true) {
            ...
            if (varName != null) {
                ...
                node = nodeCreateName;
                nodeTransform = catchCondition != null ? transform(catchCondition) : new EmptyExpression();
            } else {
                node = null;
                nodeTransform = null;
            }
            block.addChildToBack(createCatch(node, nodeTransform, transform(next.getBody()), next.getLineno(), next.getColumn()));
        }
        return createTryCatchFinally(nodeTransform2, block, tryStatement.getFinallyBlock() != null ? transform(tryStatement.getFinallyBlock()) : null, tryStatement.getLineno(), tryStatement.getColumn());
    }
    ...
    private Node transformVariableInitializers(VariableDeclaration variableDeclaration) {
        ...
        for (VariableInitializer variableInitializer : variableDeclaration.getVariables()) {
            ...
            if (!variableInitializer.isDestructuring()) {
                ...
                try {
                    variableDeclaration.addChildToBack(this.parser.createDestructuringAssignment(variableDeclaration.getType(), nodeTransform, nodeTransform2, new j(this)));
                    this.astNodePos.pop();
                } catch (Throwable th) {
                    this.astNodePos.pop();
                    throw th;

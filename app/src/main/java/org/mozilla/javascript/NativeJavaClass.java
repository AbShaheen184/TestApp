...
public class NativeJavaClass extends NativeJavaObject implements Function {
    ...
    private static Class<?> findNestedClass(Class<?> cls, String str) {
        String strI = androidx.compose.runtime.external.kotlinx.collections.immutable.internal.c.i(cls.getName(), "$", str);
        ClassLoader classLoader = cls.getClassLoader();
        return classLoader == null ? Kit.classOrNull(strI) : Kit.classOrNull(classLoader, strI);
    }
    ...
    public String toString() {
        return androidx.privacysandbox.ads.adservices.java.internal.a.q("[JavaClass ", getClassObject().getName(), "]");
    }

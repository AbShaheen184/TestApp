...
public class Slot implements Serializable {
    ...
    public void throwNoSetterException(Scriptable scriptable, Object obj) {
        ...
        if (context.isStrictMode() || context.hasFeature(11)) {
            throw ScriptRuntime.typeErrorById("msg.set.prop.no.setter", this.name != null ? coil3.compose.internal.f.e("[", scriptable.getClassName(), "].", String.valueOf(this.name)) : "", Context.toString(obj));
        }
    }

...
public class NativeObject extends IdScriptableObject implements Map {
                ...
                public Map.Entry<Object, Object> next() {
                    ...
                    return new Map.Entry<Object, Object>() { // from class: org.mozilla.javascript.NativeObject.EntrySet.1.1
                        ...
                        public String toString() {
                            return androidx.compose.runtime.external.kotlinx.collections.immutable.internal.c.i(String.valueOf(obj), "=", String.valueOf(obj2));
                        }
                    };
                }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:108:0x0149, code lost:
        ...
        if (isEnumerable(r2, r21) != false) goto L109;
     */

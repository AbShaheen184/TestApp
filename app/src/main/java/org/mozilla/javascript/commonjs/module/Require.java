...
public class Require extends BaseFunction {
    ...
    private Scriptable getExportedModuleInterface(Context context, String str, URI uri, URI uri2, boolean z) throws Throwable {
        ...
        if (scriptable2 != null) {
            ...
            c.r("Attempt to set main module after it was loaded");
            return null;
        }
    ...
    public Scriptable requireMain(Context context, String str) throws Throwable {
        ...
        if (str3 != null) {
            ...
            c.r(androidx.compose.runtime.external.kotlinx.collections.immutable.internal.c.h("Main module already set to ", this.mainModuleId));
            return null;
        }
        try {

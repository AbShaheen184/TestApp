...
public class BaseFunction extends IdScriptableObject implements Function {
    ...
    public Scriptable construct(Context context, Scriptable scriptable, Object[] objArr) {
        ...
        if (!(objCall2 instanceof Scriptable)) {
            net.luminis.tls.engine.impl.c.r(coil3.compose.internal.f.e("Bad implementation of call as constructor, name=", getFunctionName(), " in ", getClass().getName()));
            return null;
        }
    ...
    public Object getInstanceIdValue(int i) {
        ...
        if (i != 3) {
            if (i != 4) {
                return i != 5 ? super.getInstanceIdValue(i) : getArguments();
            }

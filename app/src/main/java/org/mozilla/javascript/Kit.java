...
public class Kit {
    ...
    public static RuntimeException codeBug(String str) {
        IllegalStateException illegalStateException = new IllegalStateException(androidx.compose.runtime.external.kotlinx.collections.immutable.internal.c.h("FAILED ASSERTION: ", str));
    ...
    public static String readReader(Reader reader) {
        ...
        try {
            ...
            while (true) {
                int i = bufferedReader.read(cArr, 0, LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY);
                if (i == -1) {
    ...
    public static byte[] readStream(InputStream inputStream, int i) throws IOException {
        int i2;
        if (i <= 0) {
            net.luminis.tls.engine.impl.c.o(androidx.privacysandbox.ads.adservices.java.internal.a.l(i, "Bad initialBufferCapacity: "));
            return null;
        }

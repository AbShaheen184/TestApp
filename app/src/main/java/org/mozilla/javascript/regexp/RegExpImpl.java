...
public class RegExpImpl implements RegExpProxy {
        ...
        if (languageVersion != 0 && languageVersion <= 140) {
            if (cCharAt != '0') {
                ...
                while (true) {
                    ...
                    if (!NativeRegExp.isDigit(cCharAt2)) {
                        break;
                    }
                    int i5 = (cCharAt2 - '0') + (i4 * 10);
                    if (i5 < i4) {
                        break;
                    }
                    i4 = i5;
            ...
            if (i7 < length) {
                ...
                if (NativeRegExp.isDigit(cCharAt3)) {
                    int i8 = (cCharAt3 - '0') + (i6 * 10);
                    if (i8 <= length2) {
                        i3 = i + 3;
                        i4 = i8;
                    } else {
    ...
    /* JADX WARN: Code duplicated, block: B:100:0x0118 A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:101:0x014f A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:87:0x011c A[RETURN] */
    /* JADX WARN: Code duplicated, block: B:88:0x011d  */
    /* JADX WARN: Code duplicated, block: B:92:0x0164 A[LOOP:0: B:75:0x00ff->B:92:0x0164, LOOP_END] */
    ...
    public Object action(Context context, Scriptable scriptable, Scriptable scriptable2, Object[] objArr, int i) {
        ...
        if (!z) {
            ...
            while (true) {
                if (string.isEmpty()) {
                    ...
                    i3 = i2 + length2;
                    regExpImpl.rightContext = new SubString(str, i3, (length - i2) - length2);
                    int i6 = i4;
                    GlobData globData2 = globData;
                    regExpImpl2 = this;
                ...
                iIndexOf = str.indexOf(string, i4);
                i2 = iIndexOf;
                if (i2 == -1) {
                    if (globData.charBuf == null) {
                        break;
                ...
                regExpImpl2 = this;
                replace_glob(globData3, context, scriptable, regExpImpl2, i8, i2 - i8);
                globData = globData3;
                if (i != 3) {
                    regExpImpl = regExpImpl2;
                    i5 = i2;
                ...
                SubString subString2 = regExpImpl2.rightContext;
                StringBuilder sb2 = globData.charBuf;
                String str3 = subString2.str;
                int i9 = subString2.index;
                sb2.append((CharSequence) str3, i9, subString2.length + i9);
                return globData.charBuf.toString();
            }
        }
        ...
        if (globData.charBuf == null) {
            ...
            replace_glob(globData, context, scriptable, this, subString3.index, subString3.length);
            globData = globData;
            regExpImpl = this;
        }
        regExpImpl2 = regExpImpl;
        SubString subString4 = regExpImpl2.rightContext;
        StringBuilder sb3 = globData.charBuf;
        String str4 = subString4.str;
        int i10 = subString4.index;
        sb3.append((CharSequence) str4, i10, subString4.length + i10);
        return globData.charBuf.toString();
    }

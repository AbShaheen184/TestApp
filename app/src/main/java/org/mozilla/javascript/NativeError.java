...
final class NativeError extends IdScriptableObject {
    ...
    private static Object js_toString(Scriptable scriptable) {
        ...
        return string2.isEmpty() ? string : androidx.compose.runtime.external.kotlinx.collections.immutable.internal.c.i(string, ": ", string2);
    }
    ...
    public void fillConstructorProperties(IdFunctionObject idFunctionObject) {
        ...
        final ProtoProps protoProps = new ProtoProps(0);
        associateValue("_ErrorPrototypeProps", protoProps);
        final int i = 0;
        idFunctionObject.defineProperty("stackTraceLimit", new r(0, protoProps), new Consumer() { // from class: org.mozilla.javascript.s
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                switch (i) {
                    case 0:
                        protoProps.setStackTraceLimit(obj);
                        break;
                    default:
                        protoProps.setPrepareStackTrace(obj);
                        break;
                }
            }
        }, 0);
        final int i2 = 1;
        idFunctionObject.defineProperty("prepareStackTrace", new r(1, protoProps), new Consumer() { // from class: org.mozilla.javascript.s
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                switch (i2) {
                    case 0:
    ...
    public void setStackProvider(RhinoException rhinoException) {
        if (this.stackProvider == null) {
            defineProperty(STACK_TAG, new r(2, this), new q(this, 0), 2);
        }

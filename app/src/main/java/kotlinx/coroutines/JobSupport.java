...
public class JobSupport implements Job, ChildJob, ParentJob {
    ...
    public final class SelectOnJoinCompletionHandler extends JobNode {
        ...
        @Override // kotlinx.coroutines.JobNode
        public void invoke(Throwable th) {
            this.select.trySelect(JobSupport.this, y.a);
        }
    }
    ...
    public final Object awaitSuspend(d<Object> dVar) {
        AwaitContinuation awaitContinuation = new AwaitContinuation(e.g(dVar), this);
    ...
    public static /* synthetic */ JobCancellationException defaultCancellationException$kotlinx_coroutines_core$default(JobSupport jobSupport, String str, Throwable th, int i, Object obj) {
        if (obj != null) {
            b.r("Super calls with default arguments not supported in this target, function: defaultCancellationException");
            return null;
        }
        if ((i & 1) != 0) {
            str = null;
    ...
    private final NodeList getOrPromoteCancellingList(Incomplete incomplete) {
        ...
        b.u(incomplete, "State should have list: ");
        return null;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final Object joinSuspend(d<? super y> dVar) {
        ...
        while (true) {
            ...
            if (!incomplete.isActive()) {
                ...
                if (objTryMakeCompleting == JobSupportKt.COMPLETING_ALREADY) {
                    b.u(state$kotlinx_coroutines_core, "Cannot happen in ");
                    return null;
                }
    ...
    private final void notifyCancelling(NodeList nodeList, Throwable th) throws Throwable {
        ...
        for (LockFreeLinkedListNode nextNode = (LockFreeLinkedListNode) next; !kotlin.jvm.internal.l.a(nextNode, nodeList); nextNode = nextNode.getNextNode()) {
    ...
    private final void notifyHandlers(NodeList nodeList, Throwable th, l lVar) throws Throwable {
        Object next = nodeList.getNext();
        next.getClass();
        CompletionHandlerException completionHandlerException = null;
        for (LockFreeLinkedListNode nextNode = (LockFreeLinkedListNode) next; !kotlin.jvm.internal.l.a(nextNode, nodeList); nextNode = nextNode.getNextNode()) {
    ...
    private final void promoteEmptyToNodeList(Empty empty) {
        ...
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = _state$volatile$FU;
        while (!atomicReferenceFieldUpdater.compareAndSet(this, empty, inactiveNodeList) && atomicReferenceFieldUpdater.get(this) == empty) {
        }
    }
    ...
    public static /* synthetic */ CancellationException toCancellationException$default(JobSupport jobSupport, Throwable th, String str, int i, Object obj) {
        if (obj != null) {
            b.r("Super calls with default arguments not supported in this target, function: toCancellationException");
            return null;
        }
        if ((i & 1) != 0) {
            str = null;
    ...
    private final boolean tryMakeCancelling(Incomplete incomplete, Throwable th) throws Throwable {
        ...
        Finishing finishing = new Finishing(orPromoteCancellingList, false, th);
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = _state$volatile$FU;
    ...
    public <E extends g> E get(h hVar) {
        return (E) Job.DefaultImpls.get(this, hVar);
    }
    ...
    public final CancellationException getCancellationException() {
        ...
        if (!(state$kotlinx_coroutines_core instanceof Finishing)) {
            if (state$kotlinx_coroutines_core instanceof Incomplete) {
                b.u(this, "Job is still new or active: ");
                return null;
            }
            if (state$kotlinx_coroutines_core instanceof CompletedExceptionally) {
    ...
    public CancellationException getChildJobCancellationCause() {
        ...
        if (state$kotlinx_coroutines_core instanceof Finishing) {
            ...
            if (state$kotlinx_coroutines_core instanceof Incomplete) {
                b.u(state$kotlinx_coroutines_core, "Cannot be cancelling child in this state: ");
                return null;
            }
            rootCause = null;
        }
    ...
    public final kotlin.sequences.h getChildren() {
        return new s(new JobSupport$children$1(this, null));
    }

    public final Object getCompletedInternal$kotlinx_coroutines_core() throws Throwable {
        Object state$kotlinx_coroutines_core = getState$kotlinx_coroutines_core();
        if (state$kotlinx_coroutines_core instanceof Incomplete) {
            net.luminis.tls.engine.impl.c.r("This job has not completed yet");
            return null;
        }
        if (state$kotlinx_coroutines_core instanceof CompletedExceptionally) {
            throw ((CompletedExceptionally) state$kotlinx_coroutines_core).cause;
    ...
    public final SelectClause1<?> getOnAwaitInternal() {
        ...
        jobSupport$onAwaitInternal$1.getClass();
        c0.c(3, jobSupport$onAwaitInternal$1);
        JobSupport$onAwaitInternal$2 jobSupport$onAwaitInternal$2 = JobSupport$onAwaitInternal$2.INSTANCE;
        jobSupport$onAwaitInternal$2.getClass();
        c0.c(3, jobSupport$onAwaitInternal$2);
    ...
    public final SelectClause0 getOnJoin() {
        ...
        jobSupport$onJoin$1.getClass();
        c0.c(3, jobSupport$onJoin$1);
    ...
    @Override // kotlinx.coroutines.Job
    public final DisposableHandle invokeOnCompletion(boolean z, boolean z2, l lVar) {
        return invokeOnCompletionInternal$kotlinx_coroutines_core(z2, z ? new InvokeOnCancelling(lVar) : new InvokeOnCompletion(lVar));
    }
    ...
    @Override // kotlinx.coroutines.Job
    public final Object join(d<? super y> dVar) {
        boolean zJoinInternal = joinInternal();
        y yVar = y.a;
        if (zJoinInternal) {
            Object objJoinSuspend = joinSuspend(dVar);
            return objJoinSuspend == kotlin.coroutines.intrinsics.a.e ? objJoinSuspend : yVar;
        }
    ...
    public i minusKey(h hVar) {
        return Job.DefaultImpls.minusKey(this, hVar);
    }
    ...
    public i plus(i iVar) {
        return Job.DefaultImpls.plus(this, iVar);
    }
    ...
    public final String toDebugString() {
        ...
        sb.append('{');
        return androidx.privacysandbox.ads.adservices.java.internal.a.t(sb, stateString(getState$kotlinx_coroutines_core()), '}');
    }

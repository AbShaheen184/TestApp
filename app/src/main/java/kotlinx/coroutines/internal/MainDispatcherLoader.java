...
public final class MainDispatcherLoader {
    ...
    private final MainCoroutineDispatcher loadMainDispatcher() {
        ...
        try {
            List listR = k.r(k.n(ServiceLoader.load(MainDispatcherFactory.class, MainDispatcherFactory.class.getClassLoader()).iterator()));
            ...
            if (mainDispatcherFactory != null && (mainCoroutineDispatcherTryCreateDispatcher = MainDispatchersKt.tryCreateDispatcher(mainDispatcherFactory, listR)) != null) {

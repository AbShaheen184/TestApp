...
public final class OnDemandAllocatingPool<T> {
    ...
    public final List<T> close() {
        ...
        d dVarR = c.r(0, i);
        ArrayList arrayList = new ArrayList(p.y(dVarR, 10));
        Iterator<T> it = dVarR.iterator();
        while (it.hasNext()) {
            int iNextInt = ((z) it).nextInt();
            do {
    ...
    public final String stateRepresentation$kotlinx_coroutines_core() {
        ...
        d dVarR = c.r(0, Integer.MAX_VALUE & i);
        ArrayList arrayList = new ArrayList(p.y(dVarR, 10));
        Iterator<T> it = dVarR.iterator();
        while (it.hasNext()) {
            arrayList.add(getElements().get(((z) it).nextInt()));
        }

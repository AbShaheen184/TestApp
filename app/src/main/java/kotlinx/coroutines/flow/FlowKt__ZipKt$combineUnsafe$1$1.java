...
@e(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineUnsafe$1$1", f = "Zip.kt", l = {258, 258}, m = "invokeSuspend")
public final class FlowKt__ZipKt$combineUnsafe$1$1 extends i implements q {
    ...
    public FlowKt__ZipKt$combineUnsafe$1$1(p pVar, kotlin.coroutines.d<? super FlowKt__ZipKt$combineUnsafe$1$1> dVar) {
        super(3, dVar);
        this.$transform = pVar;
    }

...
public final class FlowKt__LogicKt$any$$inlined$collectWhile$1<T> implements FlowCollector<T> {
    final /* synthetic */ v $found$inlined;
    ...
    @e(c = "kotlinx.coroutines.flow.FlowKt__LogicKt$any$$inlined$collectWhile$1", f = "Logic.kt", l = {Token.FOR}, m = "emit")
    ...
    public FlowKt__LogicKt$any$$inlined$collectWhile$1(p pVar, v vVar) {
        this.$predicate$inlined = pVar;
        this.$found$inlined = vVar;
    }
    ...
    public Object emit(T t, kotlin.coroutines.d<? super y> dVar) {
        ...
        if (zBooleanValue) {
            flowKt__LogicKt$any$$inlined$collectWhile$1.$found$inlined.e = true;
        }
        if (zBooleanValue) {

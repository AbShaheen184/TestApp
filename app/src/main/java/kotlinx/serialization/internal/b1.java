...
public final class b1 implements kotlinx.serialization.a {
    public static final b1 a = new b1();
    public static final x b = m0.a("kotlin.UByte", i.a);

    @Override // kotlinx.serialization.a
    public final Object a(kotlinx.serialization.encoding.b bVar) {
        return new kotlin.p(bVar.u(b).y());
    }

    @Override // kotlinx.serialization.a
    public final void b(kotlinx.serialization.json.internal.n nVar, Object obj) {
        nVar.h(b).c(((kotlin.p) obj).e);
    }

...
public final class k1 implements kotlinx.serialization.a {
    public static final k1 a = new k1();
    public static final x b = m0.a("kotlin.UShort", x0.a);

    @Override // kotlinx.serialization.a
    public final Object a(kotlinx.serialization.encoding.b bVar) {
        return new kotlin.w(bVar.u(b).z());
    }

    @Override // kotlinx.serialization.a
    public final void b(kotlinx.serialization.json.internal.n nVar, Object obj) {
        nVar.h(b).q(((kotlin.w) obj).e);
    }

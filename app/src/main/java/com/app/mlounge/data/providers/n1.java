...
public final class n1 extends kotlin.coroutines.jvm.internal.i implements kotlin.jvm.functions.p {
    ...
    public n1(o1 o1Var, String str, String str2, Integer num, Integer num2, kotlin.coroutines.d dVar) {
        super(2, dVar);
        this.this$0 = o1Var;
        this.$tmdbId = str;
        this.$mediaType = str2;
    ...
    public final kotlin.coroutines.d create(Object obj, kotlin.coroutines.d dVar) {
        return new n1(this.this$0, this.$tmdbId, this.$mediaType, this.$season, this.$episode, dVar);
    }

    @Override // kotlin.jvm.functions.p
    public final Object invoke(Object obj, Object obj2) {
        return ((n1) create((CoroutineScope) obj, (kotlin.coroutines.d) obj2)).invokeSuspend(kotlin.y.a);
    }
        ...
        if (str8 != null) {
            try {
                if (!kotlin.jvm.internal.l.a(this.$mediaType, "tv") || (num = this.$season) == null || (num2 = this.$episode) == null) {
                    str = "https://torrentclaw.com/api/stremio/stream/movie/" + str8 + ".json";
                } else {
                    str = "https://torrentclaw.com/api/stremio/stream/series/" + str8 + ":" + num + ":" + num2 + ".json";
                }
                ...
                if (g0VarE.N && (j0Var = g0VarE.D) != null && (strZ = j0Var.z()) != null && (kVar = (com.google.gson.k) this.this$0.gson.d(com.google.gson.k.class, strZ)) != null && (gVarN = kVar.n("streams")) != null) {
                            ...
                            if (iIntValue <= 1) {
                                ...
                                if (kotlin.text.k.T(str9, str5, false)) {
                                    ...
                                    if (strH4 != null) {
                                        ...
                                        chqStream = new ChqStream("TorrentClaw - " + string, "magnet:?xt=urn:btih:" + strH, str2, null, "torrent", str3, null, new Integer(iIntValue), strH, new Integer(iC), Boolean.TRUE, null, null, 6144);
                                    } else {
                                        i = 0;
                                    }
                    ...
                    return kotlin.collections.o.g0(5, kotlin.collections.o.f0(arrayList, new androidx.constraintlayout.core.e(13)));
                }
            } catch (Exception e) {
                kotlin.o oVar = com.app.mlounge.util.a.a;
                coil3.compose.internal.f.i("Error: ", e.getMessage(), "TorrentClaw");
                return uVar;
            }
        }
        return uVar;

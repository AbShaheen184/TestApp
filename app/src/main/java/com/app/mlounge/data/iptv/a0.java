...
import com.app.mlounge.data.providers.g1;
...
public final class a0 extends kotlin.coroutines.jvm.internal.i implements kotlin.jvm.functions.p {
    ...
    /* JADX WARN: Code duplicated, block: B:30:0x0093 A[Catch: Exception -> 0x002d, TryCatch #0 {Exception -> 0x002d, blocks: (B:8:0x0029, B:28:0x008d, B:30:0x0093, B:31:0x00ac, B:33:0x00b2, B:34:0x00c0, B:38:0x00dc, B:15:0x003a, B:27:0x007d, B:16:0x003e, B:22:0x0061, B:24:0x006a, B:19:0x0045), top: B:42:0x000b }] */
    /* JADX WARN: Code duplicated, block: B:33:0x00b2 A[Catch: Exception -> 0x002d, LOOP:1: B:31:0x00ac->B:33:0x00b2, LOOP_END, TryCatch #0 {Exception -> 0x002d, blocks: (B:8:0x0029, B:28:0x008d, B:30:0x0093, B:31:0x00ac, B:33:0x00b2, B:34:0x00c0, B:38:0x00dc, B:15:0x003a, B:27:0x007d, B:16:0x003e, B:22:0x0061, B:24:0x006a, B:19:0x0045), top: B:42:0x000b }] */
    /* JADX WARN: Code duplicated, block: B:44:0x00da A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:47:? A[LOOP:0: B:28:0x008d->B:47:?, LOOP_END, SYNTHETIC] */
    @Override // kotlin.coroutines.jvm.internal.a
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i2 == 0) {
                kotlin.a.e(obj);
                h1 h1VarH = this.this$0.h();
                this.label = 1;
                h1VarH.getClass();
                obj = BuildersKt.withContext(Dispatchers.getIO(), new g1(h1VarH, null), this);
                if (obj == aVar) {
                }
                return aVar;
            }
            ...
            if (!list.isEmpty()) {
                ...
                this.L$0 = list;
                this.label = 2;
                if (((com.app.mlounge.data.local.dao.l) kVar2).a("plutotv", this) != aVar) {
            ...
            com.app.mlounge.util.a.a("PlaylistManager", "Failed to regenerate plutotv: " + e.getMessage());

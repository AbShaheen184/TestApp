...
public final class TraktDeviceTokenRequest {
    ...
    public final int hashCode() {
        return this.clientSecret.hashCode() + a.e(this.code.hashCode() * 31, 31, this.clientId);
    }

    public final String toString() {
        String str = this.code;
        String str2 = this.clientId;
        return a.u(c.o("TraktDeviceTokenRequest(code=", str, ", clientId=", str2, ", clientSecret="), this.clientSecret, ")");
    }
}

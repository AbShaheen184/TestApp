...
public final class c {
    ...
    public final boolean c(CharSequence charSequence) {
        ...
        if (this.E) {
            return (z ? androidx.core.text.f.d : androidx.core.text.f.c).e(charSequence, charSequence.length());
        }
        return z;
    }
    ...
    public final void i(Configuration configuration) {
        if (Build.VERSION.SDK_INT >= 31) {
            ...
            if (typeface != null) {
                this.t = androidx.compose.ui.contentcapture.b.g(configuration, typeface);
            }
            Typeface typeface2 = this.x;
            if (typeface2 != null) {
                this.w = androidx.compose.ui.contentcapture.b.g(configuration, typeface2);
            }
    ...
    public final boolean l(Typeface typeface) {
        ...
        this.u = typeface;
        Typeface typefaceG = androidx.compose.ui.contentcapture.b.g(this.a.getContext().getResources().getConfiguration(), typeface);
        this.t = typefaceG;
        if (typefaceG == null) {
            typefaceG = this.u;
        }

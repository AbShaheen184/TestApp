...
public final class f {
    ...
    public f(Context context, int i) {
        ...
        this.k = c.j(context, typedArrayObtainStyledAttributes, 3);
        c.j(context, typedArrayObtainStyledAttributes, 4);
        c.j(context, typedArrayObtainStyledAttributes, 5);
        ...
        this.a = c.j(context, typedArrayObtainStyledAttributes, 6);
        ...
        TypedArray typedArrayObtainStyledAttributes2 = context.obtainStyledAttributes(i, com.google.android.material.a.o);
    ...
    public final void b(Context context, g gVar) {
        ...
        try {
            ...
            if (context.isRestricted()) {
                ...
                j.a(context, i, new TypedValue(), 0, dVar, false, false);
            }
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (xml.getEventType() == 2 && xml.getName().equals("font-family")) {
                            TypedArray typedArrayObtainAttributes = resources.obtainAttributes(Xml.asAttributeSet(xml), androidx.core.a.b);
    ...
    public final void f(Context context, TextPaint textPaint, Typeface typeface) {
        Typeface typefaceG = androidx.compose.ui.contentcapture.b.g(context.getResources().getConfiguration(), typeface);
        if (typefaceG != null) {
            typeface = typefaceG;
        }

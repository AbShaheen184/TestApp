...
public abstract class o {
    ...
    public static String a(Context context) {
        ...
        try {
            Context context2 = (Context) com.google.android.gms.common.wrappers.b.a(context).a;
    ...
    public static String b(Context context, int i) {
        ...
        if (i == 2) {
            return com.google.android.gms.common.util.b.c(context) ? resources.getString(R.string.common_google_play_services_wear_update_text) : resources.getString(R.string.common_google_play_services_update_text, strA);
        }
        if (i == 3) {
    ...
    public static String e(Context context, String str) {
        ...
        synchronized (y0Var) {
            try {
                ...
                String str2 = (String) y0Var.get(str);
                if (str2 != null) {
                    return str2;
                }

...
public abstract class c {
    public static final com.google.common.base.c a;

    static {
        com.google.common.base.c aVar;
        try {
            aVar = new b();
    ...
    public static void f(AccessibleObject accessibleObject) {
        try {
            ...
            StringBuilder sbX = androidx.privacysandbox.ads.adservices.java.internal.a.x("Failed making ", d(accessibleObject, false), " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type.");
            sbX.append(e(e));
            throw new i(8, sbX.toString(), e);
        }
    }
}

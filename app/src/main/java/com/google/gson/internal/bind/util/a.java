    ...
    public static Date b(String str, ParsePosition parsePosition) throws ParseException {
        ...
        try {
            ...
            if (str == null) {
                ...
                strK = androidx.privacysandbox.ads.adservices.java.internal.a.k('\"', "\"", str);
            }
            message = e.getMessage();
            if (message != null || message.isEmpty()) {
                message = "(" + e.getClass().getName() + ")";
            }
            ParseException parseException = new ParseException(f.e("Failed to parse date [", strK, "]: ", message), parsePosition.getIndex());
            ...
            ParseException parseException2 = new ParseException(f.e("Failed to parse date [", strK, "]: ", message), parsePosition.getIndex());

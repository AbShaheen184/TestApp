...
public final class c {
    ...
    public static void b(HttpURLConnection httpURLConnection, String str, String str2, String str3) {
        ...
        Log.w("Firebase-Installations", androidx.compose.runtime.external.kotlinx.collections.immutable.internal.c.j("Firebase options used while communicating with Firebase server APIs: ", str2, ", ", str3, TextUtils.isEmpty(str) ? "" : androidx.compose.runtime.external.kotlinx.collections.immutable.internal.c.h(", ", str)));
    }

    public static long d(String str) {
        x.a("Invalid Expiration Timestamp.", d.matcher(str).matches());
    ...
    public static a e(HttpURLConnection httpURLConnection) throws IOException {
        ...
        androidx.appcompat.widget.x xVarA = b.a();
            ...
            if (strNextName.equals("name")) {
                ...
                while (jsonReader.hasNext()) {
                    ...
                    if (strNextName2.equals("token")) {
                        xVarA.z = jsonReader.nextString();
                    } else if (strNextName2.equals("expiresIn")) {
                        xVarA.A = Long.valueOf(d(jsonReader.nextString()));
                    } else {
    ...
    public static void i(HttpURLConnection httpURLConnection, byte[] bArr) throws IOException {
        ...
        if (outputStream == null) {
            net.luminis.tls.engine.impl.c.t("Cannot send request to FIS servers. No OutputStream available.");
            return;
        }
    ...
    public final HttpURLConnection c(URL url, String str) {
        ...
        try {
            ...
            com.google.firebase.heartbeatinfo.f fVar = (com.google.firebase.heartbeatinfo.f) this.b.get();
            if (fVar != null) {
                try {
                    httpURLConnection.addRequestProperty("x-firebase-client", (String) kotlin.math.a.f(((d) fVar).a()));
            ...
            String string = null;
            try {
                PackageInfo packageInfoC = com.google.android.gms.common.wrappers.b.a(context).c(64, context.getPackageName());
                ...
                if (bArrDigest == null) {
                    ...
                    for (int i2 = 0; i2 < length; i2++) {
                        char[] cArr = com.google.android.gms.common.util.b.a;

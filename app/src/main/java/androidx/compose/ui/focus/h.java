...
public abstract class h {
    ...
    public static final androidx.compose.ui.geometry.c a(View view, View view2) {
        int[] iArr = a;
        ...
        return new androidx.compose.ui.geometry.c(f2, rect.top + f, rect.width() + f2, f + rect.top + rect.height());
    }
    ...
    public static final boolean b(View view, Integer num, Rect rect) {
        ...
        if (view instanceof androidx.compose.ui.platform.u) {
            return ((androidx.compose.ui.platform.u) view).requestFocus(num.intValue(), rect);
        }
        if (rect != null) {

...
public final class l extends c {
    ...
    public final long f(float f2, float f3, float f4, float f5, c cVar) {
        ...
        float fN = com.google.firebase.b.n(f6);
        float fN2 = com.google.firebase.b.n(f7);
        float fN3 = com.google.firebase.b.n(f8);
        float[] fArr2 = e;
        return a0.b((fArr2[6] * fN3) + (fArr2[3] * fN2) + (fArr2[0] * fN), (fArr2[7] * fN3) + (fArr2[4] * fN2) + (fArr2[1] * fN), (fArr2[8] * fN3) + (fArr2[5] * fN2) + (fArr2[2] * fN), f5, cVar);
    }
}

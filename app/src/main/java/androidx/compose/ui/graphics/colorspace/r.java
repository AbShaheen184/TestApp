...
public final class r {
    ...
    public r(double d, double d2, double d3, double d4, double d5, double d6, double d7) {
        ...
        if (Double.isNaN(d2) || Double.isNaN(d3) || Double.isNaN(d4) || Double.isNaN(d5) || Double.isNaN(d6) || Double.isNaN(d7) || Double.isNaN(d)) {
            net.luminis.tls.engine.impl.c.o("Parameters cannot be NaN");
            throw null;
        }
        if (d == -2.0d || d == -3.0d) {
            return;
        ...
        if (d5 == 0.0d && (d2 == 0.0d || d == 0.0d)) {
            net.luminis.tls.engine.impl.c.o("Parameter a or g is zero, the transfer function is constant");
            throw null;
        }
        if (d5 >= 1.0d && d4 == 0.0d) {
            net.luminis.tls.engine.impl.c.o("Parameter c is zero, the transfer function is constant");
            throw null;
        }
        if ((d2 == 0.0d || d == 0.0d) && d4 == 0.0d) {
            net.luminis.tls.engine.impl.c.o("Parameter a or g is zero, and c is zero, the transfer function is constant");
            throw null;
        }
        if (d4 < 0.0d) {
            net.luminis.tls.engine.impl.c.o("The transfer function must be increasing");
            throw null;
        }
        if (d2 < 0.0d || d < 0.0d) {
            net.luminis.tls.engine.impl.c.o("The transfer function must be positive or increasing");
            throw null;
        }
    }

...
public abstract class b {
    ...
    public static final void a(c cVar, g0 g0Var) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (i0Var instanceof k0) {
                ...
                iVar.n = true;
                iVar.c();
                iVar.s.a.setFillType(k0Var.z == 1 ? Path.FillType.EVEN_ODD : Path.FillType.WINDING);
                iVar.c();
                iVar.c();
                iVar.b = k0Var.A;
                iVar.c();
    ...
    public static final void b(androidx.compose.ui.graphics.j jVar, double d, double d2, double d3, double d4, double d5, double d6, double d7, boolean z, boolean z2) {
        double d8;
        double d9;
        double d10 = d5;
        ...
        if (d22 < 0.0d) {
            ...
            b(jVar, d, d2, d3, d4, d10 * dSqrt, d6 * dSqrt, d7, z, z2);
            return;
        }
        ...
        while (i < iCeil) {
            ...
            jVar.a.cubicTo((float) ((d40 * dSqrt3) + d41), (float) ((d42 * dSqrt3) + d43), (float) (d45 - (dSqrt3 * d47)), (float) (d46 - (dSqrt3 * d48)), (float) d45, (float) d46);
            dSin2 = dSin2;
            d41 = d45;
            i = i2 + 1;
            d27 = d27;
    ...
    public static final long c(int i, int i2, String str) {
        ...
        long j20 = ((((((long) i6) * 217706) >> 16) + ((long) LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY)) + ((long) 63)) - ((long) i25);
        if (j20 < 1 || j20 > 2046) {
            return (((long) i7) << c) | (((long) Float.floatToRawIntBits(Float.parseFloat(str.substring(i, i7)))) & j);
        }
    ...
    public static final j0 d(f fVar, androidx.compose.runtime.r rVar) {
        androidx.compose.ui.unit.c cVar = (androidx.compose.ui.unit.c) rVar.j(l1.h);
        boolean zE = rVar.e((((long) Float.floatToRawIntBits(cVar.a())) & 4294967295L) | (((long) Float.floatToRawIntBits(fVar.j)) << 32));
        Object objQ = rVar.Q();
        if (zE || objQ == androidx.compose.runtime.m.a) {
            c cVar2 = new c();
            a(cVar2, fVar.f);
            long jFloatToRawIntBits = (((long) Float.floatToRawIntBits(cVar.V(fVar.b))) << 32) | (((long) Float.floatToRawIntBits(cVar.V(fVar.c))) & 4294967295L);
            ...
            String str = fVar.a;
            long j = fVar.g;
            androidx.compose.ui.graphics.m mVar = j != 16 ? new androidx.compose.ui.graphics.m(j, fVar.h) : null;
            boolean z = fVar.i;
            j0Var.C.setValue(new androidx.compose.ui.geometry.e(jFloatToRawIntBits));
            j0Var.D.setValue(Boolean.valueOf(z));
            f0 f0Var = j0Var.E;
            f0Var.g.setValue(mVar);
            f0Var.i.setValue(new androidx.compose.ui.geometry.e(jFloatToRawIntBits2));
            f0Var.c = str;
            rVar.l0(j0Var);
            objQ = j0Var;
        }
    ...
    public static final void e(List list, androidx.compose.ui.graphics.j jVar) {
        c0 c0Var;
        float f;
        float f2;
        float f3;
            ...
            if (c0Var3 instanceof k) {
                ...
                if (c0Var3 instanceof w) {
                    ...
                    if (c0Var3 instanceof a0) {
                        ...
                        float f26 = ((b0) c0Var3).c;
                        path2.lineTo(f12, f26);
                        f13 = f26;
                    } else if (c0Var3 instanceof t) {
                        t tVar = (t) c0Var3;
                        path2.rCubicTo(tVar.c, tVar.d, tVar.e, tVar.f, tVar.g, tVar.h);
                        f10 = tVar.e + f12;
                        f11 = tVar.f + f13;
                        f12 += tVar.g;
                        f8 = tVar.h;
                        ...
                        if (c0Var3 instanceof l) {
                            l lVar = (l) c0Var3;
                            path2.cubicTo(lVar.c, lVar.d, lVar.e, lVar.f, lVar.g, lVar.h);
                            f10 = lVar.e;
                            f11 = lVar.f;
                            f4 = lVar.g;
                            f5 = lVar.h;
                            ...
                            y yVar = (y) c0Var3;
                            path2.rCubicTo(f6, f7, yVar.c, yVar.d, yVar.e, yVar.f);
                            f10 = yVar.c + f12;
                            f11 = yVar.d + f13;
                            f12 += yVar.e;
                            f8 = yVar.f;
                            ...
                            q qVar = (q) c0Var3;
                            path2.cubicTo(f12, f13, qVar.c, qVar.d, qVar.e, qVar.f);
                            f10 = qVar.c;
                            f11 = qVar.d;
                            f4 = qVar.e;
                            f5 = qVar.f;
                            ...
                            if (c0Var3 instanceof p) {
                                ...
                                s sVar = (s) c0Var3;
                                float f43 = sVar.h + f12;
                                float f44 = sVar.i + f13;
                                size = size;
                                f9 = 0.0f;
                                path2 = path2;
                                i = i;
                                b(jVar, f12, f13, f43, f44, sVar.c, sVar.d, sVar.e, sVar.f, sVar.g);
                                f10 = f43;
                                f12 = f10;
                                f11 = f44;
                                f13 = f11;
                                ...
                                float f46 = jVar2.h;
                                c0Var = c0Var3;
                                b(jVar, f12, f13, f46, f45, jVar2.c, jVar2.d, jVar2.e, jVar2.f, jVar2.g);
                                f11 = f45;
                                f13 = f11;
                                f10 = f46;
                                f12 = f10;

...
public final class d3 implements kotlin.jvm.functions.p {
    ...
    public d3(androidx.compose.ui.r rVar, androidx.compose.ui.graphics.n0 n0Var, long j, float f, androidx.compose.foundation.a0 a0Var, androidx.compose.foundation.interaction.k kVar, boolean z, kotlin.jvm.functions.a aVar, float f2, androidx.compose.runtime.internal.f fVar) {
        this.e = rVar;
        this.y = n0Var;
        this.z = j;
        this.A = f;
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if (rVar.T(iIntValue & 1, (iIntValue & 3) != 2)) {
            ...
            androidx.compose.ui.r rVarB = androidx.compose.material3.internal.g.b(androidx.compose.foundation.s.i(f3.c(this.e.d(r1.b), this.y, f3.d(this.z, this.A, rVar), this.B, ((androidx.compose.ui.unit.c) rVar.j(androidx.compose.ui.platform.l1.h)).V(this.F)), this.C, u2.a(false, 0.0f, 7), this.D, null, this.E, 24));

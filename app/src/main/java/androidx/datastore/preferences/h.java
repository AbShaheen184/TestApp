...
public final class h extends t {
    ...
    public static g D() {
        return (g) ((r) DEFAULT_INSTANCE.c(5));
    }
    ...
    public static void p(h hVar, androidx.datastore.preferences.protobuf.f fVar) {
        hVar.getClass();
        hVar.valueCase_ = 8;
        hVar.value_ = fVar;
    }
    ...
    public final androidx.datastore.preferences.protobuf.f u() {
        return this.valueCase_ == 8 ? (androidx.datastore.preferences.protobuf.f) this.value_ : androidx.datastore.preferences.protobuf.f.z;
    }

...
public final class x extends SpannableStringBuilder {
    ...
    public x(Class cls, CharSequence charSequence) {
        ...
        com.google.firebase.b.h(cls, "watcherClass cannot be null");
        this.e = cls;
    }
    ...
    public final void a() {
        ...
        while (true) {
            ...
            ((w) arrayList.get(i)).y.incrementAndGet();
            i++;
        }
    }
    ...
    public final void e() {
        ...
        while (true) {
            ...
            ((w) arrayList.get(i)).y.decrementAndGet();
            i++;
        }
    }

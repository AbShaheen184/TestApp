...
public final class b implements g0 {
    ...
    public b(int i, int i2, String str, String str2, String str3, boolean z) {
        com.google.android.material.motion.a.f(i2 == -1 || i2 > 0);
        this.a = i;
        this.b = str;
        this.c = str2;
        this.d = str3;
    ...
    public static b d(Map map) {
        ...
        if (list != null) {
            ...
            try {
                ...
                if (i2 > 0) {
                    ...
                    try {
                        androidx.media3.common.util.c.t("IcyHeaders", "Invalid bitrate: " + str4);
                        z = false;
                        i2 = -1;
                    } catch (NumberFormatException unused) {
                        androidx.compose.runtime.external.kotlinx.collections.immutable.internal.c.x("Invalid bitrate header: ", str4, "IcyHeaders");
                        z = false;
                    }
                }
        ...
        if (list6 != null) {
            ...
            try {
                ...
                if (i4 > 0) {
                    ...
                    try {
                        androidx.media3.common.util.c.t("IcyHeaders", "Invalid metadata interval: " + str5);
                        z2 = z;
                    } catch (NumberFormatException unused3) {
                        i3 = i4;
                        androidx.compose.runtime.external.kotlinx.collections.immutable.internal.c.x("Invalid metadata interval: ", str5, "IcyHeaders");
                    }
                }
                z = z2;
        ...
        int i5 = i3;
        if (z) {
            return new b(i, i5, str, str2, str3, zEquals);
        }
        return null;
    }

    ...
    public static ColorStateList b(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == 2 && depth <= depth2 && xmlPullParser.getName().equals("item")) {
                ...
                if (f != 1.0f || z) {
                    int iF = android.support.v4.media.session.b.f((int) ((Color.alpha(color) * f) + 0.5f), 0, 255);
                    if (z) {
                        a aVarA = a.a(color);
                        float f4 = aVarA.a;
                        float f5 = aVarA.b;
                        ...
                        if (f5 >= 1.0d && Math.round(f2) > 0.0d && Math.round(f2) < 100.0d) {
                            ...
                            while (true) {
                                ...
                                while (true) {
                                    ...
                                    iArrTrimStateSet = iArrTrimStateSet;
                                    int iC2 = a.b(f12, f7, fMin).c(k.k);
                                    float fD = b.d(Color.red(iC2));
                                    float fD2 = b.d(Color.green(iC2));
                                    float fD3 = b.d(Color.blue(iC2));
                                    float[] fArr = b.d[r16 == true ? 1 : 0];
                                    float f13 = ((fD3 * fArr[2]) + ((fD2 * fArr[r16 == true ? 1 : 0]) + (fD * fArr[0]))) / f3;
                                    float fCbrt = f13 <= 0.008856452f ? f13 * 903.2963f : (((float) Math.cbrt(f13)) * 116.0f) - 16.0f;
                                    float fAbs = Math.abs(f2 - fCbrt);
                                    if (fAbs < 0.2f) {
                                        a aVarA2 = a.a(iC2);
                                        a aVarB = a.b(aVarA2.c, aVarA2.b, fMin);
                                        float f14 = aVarA2.d - aVarB.d;
                                        float f15 = aVarA2.e - aVarB.e;
                                        float f16 = aVarA2.f - aVarB.f;
                                        depth2 = depth2;

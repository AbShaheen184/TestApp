...
public final class a {
    ...
    public static a a(int i) {
        ...
        float[][] fArr = b.d;
        float[] fArr2 = fArr[0];
        float f = (fArr2[2] * fD3) + (fArr2[1] * fD2) + (fArr2[0] * fD);
        float[] fArr3 = fArr[1];
        float f2 = (fArr3[2] * fD3) + (fArr3[1] * fD2) + (fArr3[0] * fD);
        float[] fArr4 = fArr[2];
        float f3 = (fD3 * fArr4[2]) + (fD2 * fArr4[1]) + (fD * fArr4[0]);
        float[][] fArr5 = b.a;
        float[] fArr6 = fArr5[0];
    ...
    public final int c(k kVar) {
        ...
        float[] fArr5 = fArr2[2];
        return androidx.core.graphics.a.a(f18, f19, (f17 * fArr5[2]) + (f16 * fArr5[1]) + (f15 * fArr5[0]));
    }
}

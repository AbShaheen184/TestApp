...
public class FileProvider extends ContentProvider {
    ...
    public static Uri d(Context context, String str, File file) {
        ...
        try {
            ...
            for (Map.Entry entry2 : aVarC.b.entrySet()) {
            ...
            if (entry == null) {
                c.o(androidx.compose.runtime.external.kotlinx.collections.immutable.internal.c.h("Failed to find configured root that contains ", canonicalPath));
                return null;
            }
            String path2 = ((File) entry.getValue()).getPath();
            return new Uri.Builder().scheme("content").authority(aVarC.a).encodedPath(Uri.encode((String) entry.getKey()) + '/' + Uri.encode(path2.endsWith("/") ? canonicalPath.substring(path2.length()) : canonicalPath.substring(path2.length() + 1), "/")).build();
        } catch (IOException unused) {
            b.g(file, "Failed to resolve canonical path for ");
            return null;
        }
    }
    ...
    public static a e(Context context, String str) throws XmlPullParserException, IOException {
        ...
        if (providerInfoResolveContentProvider == null) {
            c.o(androidx.compose.runtime.external.kotlinx.collections.immutable.internal.c.h("Couldn't find meta-data for provider with authority ", str));
            return null;
        }
        ...
        if (xmlResourceParserLoadXmlMetaData == null) {
            c.o("Missing android.support.FILE_PROVIDER_PATHS meta-data");
            return null;
        }
        while (true) {
            ...
            if (next == 2) {
                ...
                if (externalStorageDirectory == null) {
                    ...
                    if (TextUtils.isEmpty(attributeValue)) {
                        c.o("Name must not be empty");
                        return null;
                    }
                    try {
                        aVar.b.put(attributeValue, externalStorageDirectory.getCanonicalFile());
                    } catch (IOException e) {
    ...
    public final ParcelFileDescriptor openFile(Uri uri, String str) {
        ...
        if ("r".equals(str)) {
            ...
            if (!"rwt".equals(str)) {
                c.o(androidx.compose.runtime.external.kotlinx.collections.immutable.internal.c.h("Invalid mode: ", str));
                return null;
            }
            i = 1006632960;
        }

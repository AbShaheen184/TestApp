...
public final class o {
    ...
    public final boolean c(int i, int i2, int i3, int[] iArr, int[] iArr2) {
        ...
        if (viewParentE instanceof p) {
            ((p) viewParentE).h(viewGroup, i, i2, iArr3, i3);
        } else if (i3 == 0) {
            try {
        ...
        if (this.d && (viewParentE = e(i5)) != null) {
            if (i != 0 || i2 != 0 || i3 != 0 || i4 != 0) {
                ...
                if (viewParentE instanceof q) {
                    ((q) viewParentE).c(viewGroup, i, i2, i3, i4, i5, iArr3);
                } else {
                    iArr3[0] = iArr3[0] + i3;
                    iArr3[1] = iArr3[1] + i4;
                    if (viewParentE instanceof p) {
                        ((p) viewParentE).d(viewGroup, i, i2, i3, i4, i5);
                    } else if (i5 == 0) {
                        try {
        ...
        if (!f(i2)) {
            if (this.d) {
                ...
                for (ViewParent parent = view.getParent(); parent != null; parent = parent.getParent()) {
                    boolean z = parent instanceof p;
                    if (z) {
                        zOnStartNestedScroll = ((p) parent).e(view2, view, i, i2);
                    } else if (i2 == 0) {
                        try {
    ...
    public final void h(int i) {
        ...
        if (viewParentE != null) {
            boolean z = viewParentE instanceof p;
            ViewGroup viewGroup = this.c;
            if (z) {
                ((p) viewParentE).g(viewGroup, i);
            } else if (i == 0) {
                try {

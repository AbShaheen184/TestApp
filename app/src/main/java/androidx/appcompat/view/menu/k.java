...
public final class k implements MenuItem {
    ...
    public k(j jVar, int i, int i2, int i3, int i4, CharSequence charSequence) {
        this.n = jVar;
        this.a = i2;
        this.b = i;
        this.c = i3;
    ...
    public final Drawable getIcon() {
        ...
        Drawable drawableP = coil3.network.g.p(this.n.a, i);
        this.m = 0;
        this.l = drawableP;
        return b(drawableP);
    }
    ...
    public final MenuItem setChecked(boolean z) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            ...
            if (kVar.b == this.b && (kVar.x & 4) != 0 && kVar.isCheckable()) {
    ...
    public final void setShowAsAction(int i) {
        int i2 = i & 3;
        if (i2 != 0 && i2 != 1 && i2 != 2) {
            net.luminis.tls.engine.impl.c.o("SHOW_AS_ACTION_ALWAYS, SHOW_AS_ACTION_IF_ROOM, and SHOW_AS_ACTION_NEVER are mutually exclusive.");
            return;
        }
        this.y = i;
        j jVar = this.n;

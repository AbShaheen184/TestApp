...
public final class d {
    ...
    public d(Context context, CoordinatorLayout coordinatorLayout, com.google.firebase.b bVar) {
        if (bVar == null) {
            net.luminis.tls.engine.impl.c.o("Callback may not be null");
            throw null;
        }
    ...
    public final void b(View view, int i) {
        ...
        if (parent != coordinatorLayout) {
            net.luminis.tls.engine.impl.c.d(coordinatorLayout, ")", "captureChildView: parameter must be a descendant of the ViewDragHelper's tracked parent view (");
            return;
        }
        this.r = view;
        this.c = i;
    ...
    public final boolean c(View view, float f, float f2) {
        if (view != null) {
            com.google.firebase.b bVar = this.q;
            boolean z = bVar.v(view) > 0;
            boolean z2 = bVar.w() > 0;
            if (z && z2) {
                float f3 = (f2 * f2) + (f * f);
                int i = this.b;
    ...
    public final boolean h(int i, int i2, int i3, int i4) {
        ...
        float f6 = f3 / f4;
        com.google.firebase.b bVar = this.q;
        overScroller.startScroll(left, top, i5, i6, (int) ((e(i6, i4, bVar.w()) * f6) + (e(i5, i3, bVar.v(view)) * f5)));
        n(2);
        return true;
    }
    ...
    public final boolean o(int i, int i2) {
        ...
        net.luminis.tls.engine.impl.c.r("Cannot settleCapturedViewAt outside of a call to Callback#onViewReleased");
        return false;
    }
            ...
            for (int i4 = 0; i4 < pointerCount; i4++) {
                ...
                if (i(pointerId3)) {
                    ...
                    if (!z) {
                        ...
                        com.google.firebase.b bVar = this.q;
                        int i9 = bVar.i(viewG3, ((int) f) + left);
                        int top = viewG3.getTop();
                        int iJ = bVar.j(viewG3, ((int) f2) + top);
                        int iV = bVar.v(viewG3);
                        int iW = bVar.w();
                        if ((iV == 0 || (iV > 0 && i9 == left)) && (iW == 0 || (iW > 0 && iJ == top))) {
                            break;
                        }
                        Math.abs(f);
                        Math.abs(f2);
                        ...
                        if (this.a != 1 || (z && q(viewG3, pointerId3))) {
                            break;
                        }
                    }
                }
